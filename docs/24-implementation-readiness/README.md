...
first_priority: deterministic_testable_headless_core
ui_unlock_dependency: docs/25-headless-test-architecture/
```
...
| # | Artifact | Dosya |
|---:|---|---|
| 1 | Headless Implementation Principles and Guardrails | `01-implementation-principles-guardrails.md` |
| 2 | Repository and Headless Application Topology | `02-repository-application-topology.md` |
| 3 | Package and Module Boundaries | `03-package-module-boundaries.md` |
| 4 | First Headless Vertical Slice | `04-first-vertical-slice.md` |
