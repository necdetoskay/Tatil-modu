...
```yaml
product_ux_design_state: first_phase_in_progress
product_ux_first_phase_completed: false
...
| # | Artifact | Dosya |
|---:|---|---|
| 1 | Product UX Boundary and Principles | `01-product-ux-boundary-principles.md` |
| 2 | Target Household and Usage Context | `02-target-household-usage-context.md` |
| 3 | Primary Planning Journey | `03-primary-planning-journey.md` |
| 4 | Intake and Missing Information Flow | `04-intake-missing-information-flow.md` |
| 5 | Constraint Confirmation and Editing Flow | `05-constraint-confirmation-editing-flow.md` |
| 6 | Plan Preview and Progressive Disclosure | `06-plan-preview-progressive-disclosure.md` |
| 7 | Daily Itinerary Presentation Model | `07-daily-itinerary-presentation-model.md` |
| 8 | Alternative Comparison and Rejection Explanation | `08-alternative-comparison-rejection-explanation.md` |
| 9 | Evidence, Uncertainty and Warning Presentation | `09-evidence-uncertainty-warning-presentation.md` |
| 10 | Plan Revision Interaction Flow | `10-plan-revision-interaction-flow.md` |
| 11 | Memory Suggestion and Consent Flow | `11-memory-suggestion-consent-flow.md` |
| 12 | Final Plan Output Structure | `12-final-plan-output-structure.md` |
| 13 | Accessibility and Family-Use Considerations | `13-accessibility-family-use-considerations.md` |
| 14 | Product UX Completion Checklist | `14-product-ux-completion-checklist.md` |
